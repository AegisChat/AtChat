...
public class User {
    ...
    private User(){
        ...
        friends_list_file = new File("C:\\Users\\Avi\\Documents\\NetBeansProjects\\AtChat\\text\\friends_list.txt");
        blocked_list_file = new File("C:\\Users\\Avi\\Documents\\NetBeansProjects\\AtChat\\text\\blocked_list.txt");
        try {
